package com.kris.greed.constant;
...
public final class NationalDataConstant {
    ...
    public static final String SEARCH_PHRASE_PRODUCT = "地区生产总值";

    public static final String SEARCH_PHRASE_POPULATION = "人口";
    ...
    public static final String DATASOURCE_KEY_2 = "data";

    public static final String EXCEL_MAP_KEY_YEAR = "year";

    public static final String EXCEL_MAP_KEY_AREA = "area";

    public static final List<String> districtList = Arrays.asList("河北", "山西", "内蒙古自治区", "黑龙江", "吉林", "辽宁",
